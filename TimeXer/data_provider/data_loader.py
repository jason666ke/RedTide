...
class Dataset_Print_For_Pred(Dataset):
    def __init__(self, args, root_path, flag='print_for_test', size=None,
                 features='S', data_path='ETTh1.csv',
                 target='OT', scale=False, inverse=False, timeenc=0, freq='h', cols=None):
        # size [seq_len, label_len, pred_len]
        # info
    ...
    def __getitem__(self, index):
        ...
        print(f"seq_y length: {len(self.data_y[r_begin:r_end])}")
        print(f"Total length of self.data_y: {len(self.data_y)}")
