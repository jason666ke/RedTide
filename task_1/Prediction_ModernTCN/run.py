...
parser.add_argument('--result_file', type=str, default='prediction.csv', help='data file')
parser.add_argument('--pic_path', type=str, default='./pics', help='data file')
...
parser.add_argument('--scale', type=str2bool, default=True, help='scale')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if not args.do_predict:
                ...
                exp.test(setting)
                # exp.print_predict(setting, False)
